...
public class ListaSimple<T extends Comparable> implements IListaSimple<T> {
    ...
    */
    ...
    public Cola listaACola(){
        ...
        //Lista invertida
        Nodo<T> listaInvertida = null;
        
        Nodo<T> aux = this.lista;
        while(aux != null){
            
            Nodo<T> nuevo = new Nodo(aux.getDato());
            nuevo.setSiguiente(listaInvertida);
            listaInvertida = nuevo;
            
            aux = aux.getSiguiente();
        }
        
        while(listaInvertida != null){
            ret.encolar(listaInvertida.getDato());
            
            listaInvertida = listaInvertida.getSiguiente();
        }
